    ...
    <div class="card-text">
      ...
      <ul>
        ...
        <li>Use <code class="highlighter-rouge">$body-bg</code> to set a <code
            class="highlighter-rouge">background-color</code> on the <code class="highlighter-rouge">&lt;body&gt;</code>
          (<code class="highlighter-rouge">#fff</code> by default).
        </li>
      </ul>
    </div>
  </div>
      ...
      <div class="card-body pb-0">
        <div class="card-text">
          <p>All HTML headings are available with light and bold font-weight. Use <code>.text-bold-400</code> for
            light heading and <code>.text-bold-600</code> for bold headings along with heading tags or classes.</p>
        </div>
      </div>
      <div class="table-responsive">
        <table class="table table-borderless mb-0">
      ...
      <div class="card-body">
        <div class="card-text">
          ...
          <blockquote class="blockquote mt-1">
            <div class="media">
              <div class="pr-1">
                <img class="media-object img-xl rounded-circle" src="{{asset('images/portrait/small/avatar-s-3.jpg')}}"
                  alt="Generic placeholder image">
              </div>
              <div class="media-body">
                Sometimes life is going to hit you in the head with a brick. Don't lose faith.
        ...
        <div class="card-body">
          <div class="card-text">
            ...
            <ul class="list-style-icons">
              ...
              <li><i class="bx bx-folder-open"></i> Nulla volutpat aliquam velit
                <ul class="list-style-icons">
