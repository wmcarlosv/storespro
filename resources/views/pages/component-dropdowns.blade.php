    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButtonSec"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Secondary
              </button>
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton3" data-toggle="dropdown"
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton4"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Danger
              </button>
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenuButton5"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Warning
              </button>
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-light dropdown-toggle" type="button" id="dropdownMenuButton6"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Light
              </button>
          ...
          <div class="btn-group mb-1">
            <div class="dropdown">
              <button class="btn btn-dark dropdown-toggle" type="button" id="dropdownMenuButton7" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                Dark
              </button>
        ...
        <div class="card-body">
          ...
          <div class="btn-group dropdown mr-1 mb-1">
            ...
            <div class="dropdown-menu">
              <a class="dropdown-item" href="javascript:void(0);">Option 1</a>
              <a class="dropdown-item active" href="javascript:void(0);">Option 2</a>
              <a class="dropdown-item" href="javascript:void(0);">Option 3</a>
...
<!-- Outline Dropdowns starts -->
<section id="outline-dropdowns">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <div class="card-header">
        ...
        <div class="card-body">
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-outline-success dropdown-toggle" type="button" id="dropdownMenuButtonSec"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Success
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonSec">
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-outline-warning dropdown-toggle" type="button" id="dropdownMenuButton2"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Warning
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton2">
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <p>Use <code>.dropdown-item-emoji</code> within <code>.dropdown-item</code> for font-size and spacing of
            emojis.</p>
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonIcon"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="bx bx-error-circle mr-50"></i> Icon Left
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonIcon">
                <a class="dropdown-item" href="javascript:void(0);"><i class="bx bx-bar-chart-alt-2 mr-50"></i> Option
                  1</a>
          ...
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown icon-right m-0">
              <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonIconRight"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                Icon Right <i class="bx bx-error-circle ml-50"></i>
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonIconRight">
                <a class="dropdown-item justify-content-between" href="javascript:void(0);">Option 1 <i
                    class="bx bx-bar-chart-alt-2 ml-50"></i></a>
                <a class="dropdown-item justify-content-between" href="javascript:void(0);">Option 2 <i
                    class="bx bx-bell ml-50"></i></a>
                <a class="dropdown-item justify-content-between" href="javascript:void(0);">Option 3 <i
          ...
          <div class="btn-group mb-1">
            <div class="dropdown dropdown-color-icon">
              <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButtonEmoji"
                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span Class="mr-50">🙂</span>Color Emoji icons
              </button>
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButtonEmoji">
                <a class="dropdown-item" href="javascript:void(0);"><span class="dropdown-item-emoji">😆</span> Option
                  1</a>
                <a class="dropdown-item" href="javascript:void(0);"><span class="dropdown-item-emoji">😎</span> Option 2
                </a>
                <a class="dropdown-item" href="javascript:void(0);"><span class="dropdown-item-emoji">🤩</span> Option
                  3</a>
              </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          <p>
            ...
            Trigger dropdown menus at the up / right / left of the elements by adding <code>.dropup | .dropright |
              .dropleft </code> to the parent element.
          </p>
          <div class="btn-group mr-1 mb-1">
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item active" href="javascript:void(0);">Option 1</a>
                <a class="dropdown-item" href="javascript:void(0);">Option 2</a>
                <a class="dropdown-item" href="javascript:void(0);">Option 3</a>
              </div>
            </div>
  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <p>Use <code>data-offset</code> or <code>data-reference</code> attributes to change the location of the
            dropdown.</p>
          <div class="btn-group dropdown mr-1 mb-1">
