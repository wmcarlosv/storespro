          ...
          <div class="row">
            <div class="col-md-6 col-sm-12">
              ...
              <div id="chips-list-1">
                ...
                <div class="chip chip-primary draggable mr-1">
                  <div class="chip-body">
                ...
                <div class="chip chip-danger draggable mr-1">
                  <div class="chip-body">
                    <span class="chip-text">Instagram</span>
                  </div>
                </div>
                <div class="chip chip-info draggable mr-1">
                  <div class="chip-body">
                    <span class="chip-text">Discord</span>
                  </div>
                </div>
                <div class="chip chip-warning draggable mr-1">
                  <div class="chip-body">
