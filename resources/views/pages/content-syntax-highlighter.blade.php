...
&lt;/pre&gt;
  ...
  color: red
        ...
        <p>If you use that pattern,
          the <code>&lt;pre&gt;
          </code>will automatically get the <code>language-xxxx</code>class (if it doesn't already have it) and will be
          styled as
          a code block.</p>
      </div>
    </div>
...
<section id="autolinker" class="row">
  <div class=" col-12">
    <div class="card">
      ...
      <div class="card-body">
        <p>Converts URLs and emails in code to clickable links. <a href="javascript:void(0);">Parses Markdown</a> links
          in comments.</p>
