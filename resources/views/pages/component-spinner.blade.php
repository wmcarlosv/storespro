  ...
  <div class="row match-height">
    ...
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          <p>For customizing spinner with different colored options, use <code>.text-{colorName}</code> along with
            <code>.spinner-border</code>.
  ...
  <div class="row match-height">
    <div class="col-md-6 col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          <p>You can also use <code>.text-{side}</code> as a wrapper class of <code>.spinner-border</code>for the
            spinner's placement.</p>
